...
#include<iostream>
#include<fstream>
#include"AcademicAdministrator.h"
#include"Faculty.h"
#include"Students.h"
#include"Courses.h"
...
void ViewTranscript(string id)
{
	...
	if (total == 0)
		cout << "Student not registered in any course!!!!!" << endl;
	else {
		cgpa = cgpa / (total * 3);
...
void AcademicAdministrator()
{
	system("CLS");
	cout << "\t\t\t-----------------------------------------\n";
	cout << "\t\t\t     University Management System\n";
	cout << "\t\t\t-----------------------------------------\n";
	cout << "\t\t\tAcademic Administrator Portal\n";
	int i = -1;
	while (i!=0)
	{
		cout << "\n\t\t\tEnter <1> Add Course"
...
void interface()
{
	...
	while (i != 0)
	{
		...
		cout << "\t\t\t-----------------------------------------\n";
		cout << "\n\t\t\tLOGIN AS"
			<< "\n\t\t\tEnter <1> Academic Administrator"
			<< "\n\t\t\tEnter <2> Faculty"
			<< "\n\t\t\tEnter <3> Student"
			<< "\n\t\t\tEnter <0> to Exit\n";
		cout << "\n\n\t\t\tEnter Your Choice: ";
